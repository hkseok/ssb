...
class Trader(QMainWindow):
    ...
    def variable_setting(self):
        ...
        self.buy_end_time = QTime(10, 30, 0)
    ...
    def auto_trade_stock(self):
        logger.debug("auto_trade_stock 함수에 들어왔습니다!")
    ...
    def run(self):
        ...
        while 1:
            ...
            if self.market_time_check():
                ...
                # 매수 먼저 하고 싶다면 위에 auto_trad_sell_stock 과 auto_trade_stock 의 위치를 바꿔주면 된다.
                # 매도 먼저 진행하는 것은 장 시작 후 바로 급등할 경우를 대비하여 매도를 먼저 진행한 것이다.
