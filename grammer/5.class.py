print("\n*************************************ex1*************************************")
# class : 붕어빵 틀 ( 한번 만들어 놓고 다른 소스만 넣어서 재 사용 가능하다. )

# human 이라는 class 를 만든다.
class human():
...
# jake는 객체다, 그리고 jake 객체는 hunam 이라는 클래스의 인스턴스이다.
# "jake는 인스턴스" : X
# "jake는 객체" : O
# "jake는 human의 객체" : X
# "jake는 human의 인스턴스" : O
...
jake.dancing()
jake.singing("jake.singing 의 param 값에 aaa 를 넣어주자!")
